...
const DownloadIcon = forwardRef<DownloadIconHandle, DownloadIconProps>(
  ({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
      <div
        className={cn(
          `cursor-pointer select-none py-4 px-6 bg-neutral-900 border-1 border-neutral-800 rounded-xl transition-colors duration-200 flex items-center justify-center gap-2`,
          className,
        )}
